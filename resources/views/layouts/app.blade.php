                ...
                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
									<div class="ms-auto">
										<ul id="nav" class="navbar-nav ms-auto">
											...
											<li class="nav-item">
												<a class="" href="{{ route('searchbook')}}">Pencarian</a>
											</li>
											<li class="nav-item">
												<a class="" href="{{ route('daftarbuku')}}">Daftar Buku</a>
											</li>
											<li class="nav-item">
												<a class="" href="{{ route('about')}}">Tentang Kami</a>
											</li>
								...
								<div class="header-btn">
									<a href="{{ route('admin')}}" class="main-btn btn-hover">Login</a>
								</div>
              </nav>
              <!-- navbar -->
            </div>
