          ...
          <div class="content mt-200">
              <div class="pt-3 d-flex bd-highlight">
                ...
                <div class=" flex-fill bd-highlight">
                    ...
                    <div class="form-group mt-4">
                      <label for="exampleInputEmail1">Nomor Pinjaman</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  style="
                      width: 80%;
                      background: #F1FEFF;
                      border: 1px solid #37C2CC;
                      box-sizing: border-box;
                    ...
                    <a style="float: right; margin-right: 20%" href="{{ route('pengembalian-sukses')}}" class="main-btn btn-hover">Konfirmasi</a>
                    <a style="float: right; margin-right: 40%" href="{{ route('pengembalian')}}" class="main-btn btn-hover">Kembali</a>
                </div>
              </div>
